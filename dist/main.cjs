...
var require_dist_node7 = __commonJS({
  "node_modules/@octokit/oauth-methods/dist-node/index.js"(exports) {
    ...
    async function oauthRequest(request3, route, parameters) {
      ...
      if ("error" in response.data) {
        const error = new requestError.RequestError(`${response.data.error_description} (${response.data.error}, ${response.data.error_uri})`, 400, {
          request: request3.endpoint.merge(route, withOAuthParameters),
    ...
    function getWebFlowAuthorizationUrl({
      request: request$1 = request2.request,
      ...options
    }) {
...
var require_dist_node8 = __commonJS({
  "node_modules/@octokit/auth-oauth-device/dist-node/index.js"(exports) {
    ...
    function createOAuthDeviceAuth(options) {
      const requestWithDefaults = options.request || request2.request.defaults({
        headers: {
...
var require_dist_node9 = __commonJS({
  "node_modules/@octokit/auth-oauth-user/dist-node/index.js"(exports) {
    ...
    async function hook(state, request3, route, parameters = {}) {
      const endpoint = request3.endpoint.merge(route, parameters);
      if (/\/login\/(oauth\/access_token|device\/code)$/.test(endpoint.url)) {
        return request3(endpoint);
      }
    ...
    function createOAuthUserAuth2({
      ...
      clientSecret,
      clientType = "oauth-app",
      request: request$1 = request2.request.defaults({
        headers: {
...
var require_dist_node10 = __commonJS({
  "node_modules/@octokit/auth-oauth-app/dist-node/index.js"(exports) {
    ...
    async function hook(state, request3, route, parameters) {
      ...
      endpoint.headers.authorization = `basic ${credentials}`;
      try {
        return await request3(endpoint);
      } catch (error) {
        if (error.status !== 401)
          throw error;
